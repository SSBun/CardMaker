...
struct YouDaoTranslator {
    static func getInfo(
        _ vocabulary: String,
        _ callback: @escaping ((RecommendSentence, TranslationResult)?) -> Void
    ) {
        guard let trs = translate(vocabulary),
              let sct = getRecommendSentences(vocabulary)
    ...
    static func translate(
        _ vocabulary: String
    ) -> AnyPublisher<YouDaoTranslator.RecommendSentence, DataProvider.HTTPError>? {
    ...
    static func getRecommendSentences(
        _ vocabulary: String
    ) -> AnyPublisher<YouDaoTranslator.TranslationResult, DataProvider.HTTPError>? {
